...
export default function MyTicketContainer() {
    ...
    if(myTickets && myTickets.length === 0) {
        return (
            <BodyContent className="flex_center h-64 rounded-lg border border-dashed border-spacing-4 flex-col gap-3 text-sm font-medium text-secondary-foreground pt-0">
    ...
    return (
        <BodyContent className="gap-3 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 pt-0">
