                            ...
                            <ul className="flex flex-col gap-1">
                                {links.map(({ name, link }, _i) => (
                                    <li key={_i}>
                                        {name === "cookies" ?
                                            (
                                                <Button variant="link" onClick={() => setOpen(true)} className="p-0 h-auto text-muted-foreground capitalize text-xs font-normal hover:underline underline-offset-2">
                                                    {name}
                                                </Button>
                                            ) : (
                                                <Link href={link} className="capitalize text-xs font-normal text-muted-foreground hover:underline underline-offset-2">
                                                    {name}
                                                </Link>
                                            )
                                        }
